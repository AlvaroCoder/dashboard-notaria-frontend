  ...
  return (
    <div className='p-8 pb-12 space-y-6 h-screen overflow-y-auto'>
      <section className='flex flex-row justify-between'>
        <div>
          <Title1 className='text-3xl'>Detalles del Contrato SCRL</Title1>
          <p className='w-full max-w-2xl'>Información detallada del contrato Constitución de Sociedad Comercial de Responsabilidad Limitada (SCRL)</p> 
        </div>
        <div>
